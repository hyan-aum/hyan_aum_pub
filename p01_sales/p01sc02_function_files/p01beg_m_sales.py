...
def main():
    ...
    print("\nPlease enter file name 'region1_sales.csv'")
    import_sales(sales_list)  # region1_sales.csv
    ...
    import_sales(sales_list)  # sales_q4_2021_w.csv
    filename = 'sales_q4_2021_w.csv'
    add_imported_file(filename)    # sales_q4_2021_w.csv
    print("\nPlease enter file name 'sales_q4_2021_w.csv'")
    import_sales(sales_list)  # sales_q4_2021_w.csv
    view_sales(sales_list)
